  ...
  return (
    <div className={bemBlocks.item().mix(bemBlocks.container("item"))} data-qa="hit">
      <div className={bemBlocks.item("poster")}>
        <a href={url} target="_blank"><img className={bemBlocks.item("poster")} alt="presentation" data-qa="poster" src={thumbnail} width="140"/></a>
      </div>
      <a href={viewerUrl} target="_blank"><div data-qa="title" className={bemBlocks.item("title")} dangerouslySetInnerHTML={{__html:titleString}}></div></a>
    </div>
  )
}
            ...
            <div className={bemBlocks.item("details")}>
                <a href={viewerUrl} target="_blank">
                    <h2 className={bemBlocks.item("title")}
                        dangerouslySetInnerHTML={{__html: source.metadata.Title}}></h2></a>
                <table>
                      <tbody>
                      <tr>
                        <td>Image Index:</td>
                ...
                <Layout>
                    <TopBar>
                        ...
                        <SearchBox autofocus={true} searchOnChange={true}
                                   queryFields={["iiifService", "structureMap.1.@id", "structureMap.1.label", "metadata.Date", "metadata.Title", "metadata.Author",
                                       "metadata.Date of publication", "metadata.Call number",
