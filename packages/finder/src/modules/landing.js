            ...
            <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
              ...
              <ModalBody>
                <AuthUserContext.Consumer>
                  {authUser => authUser ?
                    <div>
                <img className="account-image-profile"
                  src={firebase.auth().currentUser.photoURL} alt="Account's profile image" aria-hidden="true"/>
                      <div className="gb_yb">
              ...
              <ModalFooter>
                <a className="btn btn-outline-secondary" onClick={() => firebase.auth().signOut()}>Sign-out</a>
                <Button color="secondary" onClick={this.toggle}>Cancel</Button>
              </ModalFooter>
            </Modal>
            <AuthUserContext.Consumer>
              {authUser => authUser ? <div><a onClick={this.toggle}><img className="account-image"
                src={firebase.auth().currentUser.photoURL} alt="Account's profile image" aria-hidden="true"/></a>
