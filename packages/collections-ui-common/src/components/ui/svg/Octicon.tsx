...
export class Octicon extends React.Component<any, any> {
  render() {
    return (
      <svg className='JUQOtt' viewBox="0 0 16 16">
        <path
          ...
          1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01
