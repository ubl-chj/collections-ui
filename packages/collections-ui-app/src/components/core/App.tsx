...
import {Help, Landing, Services, Settings, SignIn} from '../routes'
  ...
  render() {
    ...
    return (
        <BrowserRouter forceRefresh={!supportsHistory}>
            <Switch>
              <Route exact={t} path={Routes.ACCOUNT} component={withDynamicLayout(Account)}/>
              ...
              <Route exact={t} path={Routes.SETTINGS} component={withDynamicLayout(Settings)}/>
