...
import {MetadataSchemaAdapter, StructuredDataImageObject} from '../../schema'
...
class ControlsComponent extends ViewerComponent<IMetadataProps, any> {
  ...
  render() {
    ...
    if (document) {
      ...
      const adapter = new MetadataSchemaAdapter(metadata, ControlsComponent.buildContentUrl(), this.getThumbnail(), title)
      const schema = adapter.buildStructuredData().dataLayer
      return (
        <div className="manifest-info">
          <Menu noOverlay={true} right={true} customBurgerIcon={false} isOpen={this.state.menuOpen}
...
export const Controls = withRouter(ControlsComponent)
